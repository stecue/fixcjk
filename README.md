...
3. 由于脚本注入位置的差异，部分网页的部分内容（比如本项目在 GitHub 上的[中文 Readme 文件](https://github.com/stecue/fixcjk/blob/master/README.md)以及某些网页的动态内容）在网页载入完成时可能尚未被修正。此时可尝试单击页面内任意一点；脚本将重新检查所有元素。
