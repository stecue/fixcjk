...
**长击强力检：**（慎用）长按鼠标左键（>1.5秒）再松开后，将忽略一切内建的定时器，强力检查、修正所有可疑元素。对于页面元素超多的网页，可能会花费很长时间。一般来说，Windows平台上的Chrome&#8203;/&#8203;Opera耗时最少，Firefox则慢一些。某些Linux发行版中的Firefox可能会尤其慢，请务必慎用此功能！
