...
3. 由于脚本注入位置的差异，部分网页的部分内容（比如本项目在 GitHub 上的[中文 Readme 文件](https://github.com/stecue/fixcjk/blob/master/README.md)）在整个页面载入完成时尚未被修正。此时可单击页面内任意一点；脚本将尝试重新检查所有需修正的元素。
